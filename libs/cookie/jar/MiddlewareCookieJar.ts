...
export default class MiddlewareCookieJar extends CookieBaseJar {
  ...
  get(name: string): string | undefined {
    ...
    try {
      ...
      console.error(`[MiddlewareCookieJar.get] decrypt failed: ${name}`, e);
      return undefined;
    }
  }
  ...
  set(name: string, value: string, options?: CookieOptions): void {
    try {
      ...
      console.error(`[MiddlewareCookieJar.set] encrypt failed: ${name}`, e);
    }
  }
